...
import 'package:newui/widgets/trending/data/data.dart';
import 'package:newui/widgets/description/about_story.dart'; // Import the AboutStoryPage
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          InkWell(
            onTap: () {
              // Handle the 'TAKE CASE' button tap here
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => AboutStoryPage(),
                ),
              );
            },
            child: Container(
